defmodule ElixirConfAfricaWeb.Router do
  ...
  scope "/", ElixirConfAfricaWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ElixirConfAfricaWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", ElixirConfAfricaWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{ElixirConfAfricaWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", ElixirConfAfricaWeb do
    ...
    live_session :current_user,
      on_mount: [{ElixirConfAfricaWeb.UserAuth, :mount_current_user}] do
